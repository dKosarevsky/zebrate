...
Для автоматизированного тестирования был использован сервис `Github Actions`.
 ...
 * Пользователь может ввести ссылку на изображение лошади в поле для ввода текста
 * Пользователь может нажать на кнопку `browse files` и загрузить изображение
 лошади из хранилища на локальном устройстве
 * Пользователь может кликнуть по чекбоксу `Show me the horse tensor` и 
 загрузить тензор на локальное устройство в файле эксель с расширением  `.xlsx`
 * Пользователь может загрузить изображение лошади на локальное устройство
 * Пользователь может загрузить сгенерированное изображение зебры на локальное устройство
 ...
 * ввод ссылки с изображением лошади в поле для ввода текста [ test_put_image_link ]
 * нажатие на кнопку `browse files` и загрузка изображения из хранилища на локальном устройстве [ test_send_image_file**** ]
 * клик по чекбокс и загрузка тензора на локальное устройство [ test_download_tensor ]
 * загрузка изображения лошади на локальное устройство [ test_download_horse ]
 * загрузка изображения зебры на локальное устройство [ test_download_zebra ]
...
[Лог](https://github.com/dKosarevsky/zebrate/runs/1450078111?check_suite_focus=true) запуска автоматического pipeline:
```
